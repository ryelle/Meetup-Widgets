...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__single__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__group_list__ = __webpack_require__(4);
...
registerBlockType('meetup-widgets/single', __WEBPACK_IMPORTED_MODULE_0__single__["a" /* default */]);
registerBlockType('meetup-widgets/group-list', __WEBPACK_IMPORTED_MODULE_1__group_list__["a" /* default */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_debounce__ = __webpack_require__(9);
...
var translate = function translate(str) {
	return __(str, 'meetup-widgets');
};

var getMeetupEvents = function getMeetupEvents(_ref) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	edit: function edit(_ref2) {
		...
		attributes = _extends({}, defaultAttributes, attributes);
		getMeetupEvents(attributes);

		var onChangeEditable = function onChangeEditable(field) {
			return function (value) {
				return setAttributes(_defineProperty({}, field, value));
			};
		};

		var onFocus = function onFocus(field) {
			return function (focus) {
				return setFocus(_extends({}, focus, { editable: field }));
			};
		};

		var focusedEditable = focus ? focus.editable || 'title' : null;
		...
		return [controls, wp.element.createElement(
			'div',
			{ className: 'meetup-widgets', key: 'meetup-display' },
